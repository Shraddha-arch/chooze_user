...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 34, 105, 227),
                ...
                child: Container(
                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    ...
                    return Column(children: [
                      ...
                      Image.asset(Images.whitesignup, width: 100),
                      SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      Image.asset(Images.whitelogo, width: 100),
                      SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_LARGE),

                      Text('sign_in'.tr.toUpperCase(), style: robotoBlack.copyWith(fontSize: 30, color: Colors.white), ),
                      SizedBox(height: 50),
                      ...
                      Row(children: [
                        Expanded(
                          child: ListTile(
                            ...
                            title: Text('remember_me'.tr,style: TextStyle(color: Colors.white)),
                          ...
                          child: Center(child: SizedBox(width : Dimensions.WEB_MAX_WIDTH, child: Padding(
                            ...
                            child: TextButton(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                // ) : SizedBox(),
                                Text('sign_in'.tr, textAlign: TextAlign.center, style: robotoBold.copyWith(
                                  color: Colors.black,
