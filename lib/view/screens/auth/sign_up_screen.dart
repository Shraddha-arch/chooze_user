            ...
            child: Container(
              ...
              child: GetBuilder<AuthController>(builder: (authController) {
                ...
                return Column(children: [
                  ...
                  Text('sign_up'.tr.toUpperCase(), style: robotoBlack.copyWith(fontSize: 30, color: Colors.white)),
                  SizedBox(height: 50),
                  Container(
                      ...
                      child: Center(child: SizedBox(width : Dimensions.WEB_MAX_WIDTH, child: Padding(
                        ...
                        child: TextButton(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            // ) : SizedBox(),
                            Text('sign_up'.tr, textAlign: TextAlign.center, style: robotoBold.copyWith(
                              color: Colors.black,
