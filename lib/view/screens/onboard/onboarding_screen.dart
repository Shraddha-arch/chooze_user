              ...
              itemBuilder: (context, index) {
                return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: robotoMedium.copyWith(fontSize: context.height*0.022,color: Colors.white    ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: robotoRegular.copyWith(fontSize: context.height*0.015, color: Colors.white),
                      textAlign: TextAlign.center,
                    ),
                  ),
