...
class _CheckoutScreenState extends State<CheckoutScreen> {
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null) {
                      _cartList.forEach((cartModel) {
                        ...
                        _price = _price +
                            (cartModel.discountedPrice * cartModel.quantity);
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              items: orderController.slotIndexList.map((int value) {
                                                                                return DropdownMenuItem<int>(
                                                                                  value: value,
                                                                                  child: Text((value == 0 && orderController.selectedDateSlot == 0 && restController.isRestaurantOpenNow(restController.restaurant.active, restController.restaurant.schedules))
                                                                                      ? 'now'.tr
  ...
  // static getRoutee(Widget navigateTo) {
